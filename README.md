...
1. Download `Atlas_1.0.3_x64-setup.exe` from the
   [Atlas 1.0.3 release](https://github.com/Rifaque/atlas/releases/tag/v1.0.3).
2. Verify SHA-256: `16D953C943BF55F18D5A73F9C8C842B94203652CD2857E61F3883E51D50E7D23`.
...
pnpm version:check -- --expected 1.0.3
